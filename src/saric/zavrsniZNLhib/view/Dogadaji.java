...
public class Dogadaji extends javax.swing.JFrame {
    ...
    private final ObradaUtakmica obradaUtakmica;
    private final ObradaDogadaj obradaEntitet;
    ...
    public Dogadaji() {
        ...
        obradaEntitet = new ObradaDogadaj();
    ...
    private void btnPromjeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPromjeniActionPerformed
        Dogadaj dog = lstEntiteti.getSelectedValue();
    ...
    private void lstUtakmiceValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstUtakmiceValueChanged
        ...
        if (lstUtakmice.getSelectedValue() != null) {
            jRadioButton1.setText(lstUtakmice.getSelectedValue().getDomaci().toString());
            jRadioButton2.setText(lstUtakmice.getSelectedValue().getGosti().toString());
        }
    ...
    private void ucitajEntitete() {
        ...
        obradaEntitet.getLista().forEach((g) -> {
            ...
            if (lstUtakmice.getSelectedValue().getSifra() == g.getUtakmica().getSifra()) {
                d.addElement(g);
            }
    ...
    private void ucitajDogadaje() {
        ...
        jRadioButton1.setText(lstUtakmice.getSelectedValue().getDomaci().toString());
        jRadioButton2.setText(lstUtakmice.getSelectedValue().getGosti().toString());
        if (lstEntiteti.getSelectedValue().getSifra() < 0) {
            jRadioButton1.setText("Domaćin");
            jRadioButton1.setSelected(true);
            jRadioButton2.setText("Gost");

        } else {
            if (lstEntiteti.getSelectedValue().getMomcad().getSifra() == lstUtakmice.getSelectedValue().getDomaci().getSifra()) {
                jRadioButton1.setSelected(true);
            } else {
                jRadioButton2.setSelected(true);
            }

            txtMinuta.setText(lstEntiteti.getSelectedValue().getVrijeme());
            txtOpisDogadaja.setText(lstEntiteti.getSelectedValue().getOpis());
            ...
            for (int i = 0; i < modelVrstaDogadaja.getSize(); i++) {
                if (modelVrstaDogadaja.getElementAt(i).getSifra()
                        == lstEntiteti.getSelectedValue().getVrstadogadaja().getSifra()) {
    ...
    private Momcad postaviMomcadBtn() {
        Momcad momcad = new Momcad();
        if (jRadioButton1.isSelected()) {
            momcad = lstUtakmice.getSelectedValue().getDomaci();
        } else {
            momcad = lstUtakmice.getSelectedValue().getGosti();
        }
        return momcad;
    }
    ...
    private void ucitajUtakmice() {
        ...
        obradaUtakmica.getLista().forEach((g) -> {
            m.addElement(g);
        });
    ...
    private void ocistiPolja() {
        txtMinuta.setText("");
        txtOpisDogadaja.setText("");
        cmbVrstaDogadaja.setSelectedItem(null);
